//========================================================================
// VRegIncrNstage__p_nstages_2_v.cpp
//========================================================================
...
#include "obj_dir_RegIncrNstage__p_nstages_2/VRegIncrNstage___05Fp_nstages_2.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncrNstage__p_nstages_2/VRegIncrNstage___05Fp_nstages_2__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VRegIncrNstage__p_nstages_2_t;

  // Exposed methods
  VRegIncrNstage__p_nstages_2_t * VRegIncrNstage__p_nstages_2_create_model( const char * );
  void VRegIncrNstage__p_nstages_2_destroy_model( VRegIncrNstage__p_nstages_2_t *);
  void VRegIncrNstage__p_nstages_2_comb_eval( VRegIncrNstage__p_nstages_2_t * );
  void VRegIncrNstage__p_nstages_2_seq_eval( VRegIncrNstage__p_nstages_2_t * );
  void VRegIncrNstage__p_nstages_2_assert_on( VRegIncrNstage__p_nstages_2_t *, bool );
  bool VRegIncrNstage__p_nstages_2_has_assert_fired( VRegIncrNstage__p_nstages_2_t * );

  #if VLINETRACE
  void VRegIncrNstage__p_nstages_2_line_trace( VRegIncrNstage__p_nstages_2_t *, char * );
  #endif
...
VRegIncrNstage__p_nstages_2_t * VRegIncrNstage__p_nstages_2_create_model( const char *vcd_filename ) {

  VRegIncrNstage__p_nstages_2_t  * m;
  VRegIncrNstage___05Fp_nstages_2 * model;
  ...
  m     = new VRegIncrNstage__p_nstages_2_t;
  model = new VRegIncrNstage___05Fp_nstages_2(context_ptr);
...
void VRegIncrNstage__p_nstages_2_destroy_model( VRegIncrNstage__p_nstages_2_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncrNstage___05Fp_nstages_2 * model = (VRegIncrNstage___05Fp_nstages_2 *) m->_cffi_model;
...
void VRegIncrNstage__p_nstages_2_comb_eval( VRegIncrNstage__p_nstages_2_t * m ) {
...
void VRegIncrNstage__p_nstages_2_seq_eval( VRegIncrNstage__p_nstages_2_t * m ) {
...
void VRegIncrNstage__p_nstages_2_assert_on( VRegIncrNstage__p_nstages_2_t * m, bool enable ) {
...
bool VRegIncrNstage__p_nstages_2_has_assert_fired( VRegIncrNstage__p_nstages_2_t * m ) {
...
#if VLINETRACE
void VRegIncrNstage__p_nstages_2_line_trace( VRegIncrNstage__p_nstages_2_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_RegIncrNstage___05Fp_nstages_2__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.RegIncrNstage__p_nstages_2.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VRegIncrNstage___05Fp_nstages_2::line_trace( words );
