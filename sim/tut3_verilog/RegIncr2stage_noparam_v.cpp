...
#include "obj_dir_RegIncr2stage_noparam/VRegIncr2stage_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncr2stage_noparam/VRegIncr2stage_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VRegIncr2stage_noparam_t;

  // Exposed methods
  VRegIncr2stage_noparam_t * VRegIncr2stage_noparam_create_model( const char * );
  void VRegIncr2stage_noparam_destroy_model( VRegIncr2stage_noparam_t *);
  void VRegIncr2stage_noparam_comb_eval( VRegIncr2stage_noparam_t * );
  void VRegIncr2stage_noparam_seq_eval( VRegIncr2stage_noparam_t * );
  void VRegIncr2stage_noparam_assert_on( VRegIncr2stage_noparam_t *, bool );
  bool VRegIncr2stage_noparam_has_assert_fired( VRegIncr2stage_noparam_t * );

  #if VLINETRACE
  void VRegIncr2stage_noparam_line_trace( VRegIncr2stage_noparam_t *, char * );
  #endif
...
VRegIncr2stage_noparam_t * VRegIncr2stage_noparam_create_model( const char *vcd_filename ) {

  VRegIncr2stage_noparam_t  * m;
  VRegIncr2stage_noparam * model;
  ...
  m     = new VRegIncr2stage_noparam_t;
  model = new VRegIncr2stage_noparam(context_ptr);
...
void VRegIncr2stage_noparam_destroy_model( VRegIncr2stage_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncr2stage_noparam * model = (VRegIncr2stage_noparam *) m->_cffi_model;
...
void VRegIncr2stage_noparam_comb_eval( VRegIncr2stage_noparam_t * m ) {
...
void VRegIncr2stage_noparam_seq_eval( VRegIncr2stage_noparam_t * m ) {
...
void VRegIncr2stage_noparam_assert_on( VRegIncr2stage_noparam_t * m, bool enable ) {
...
bool VRegIncr2stage_noparam_has_assert_fired( VRegIncr2stage_noparam_t * m ) {
...
#if VLINETRACE
void VRegIncr2stage_noparam_line_trace( VRegIncr2stage_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_RegIncr2stage_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.RegIncr2stage_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VRegIncr2stage_noparam::line_trace( words );
