//========================================================================
// VRegIncrNstage__p_nstages_3_v.cpp
//========================================================================
...
#include "obj_dir_RegIncrNstage__p_nstages_3/VRegIncrNstage___05Fp_nstages_3.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncrNstage__p_nstages_3/VRegIncrNstage___05Fp_nstages_3__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VRegIncrNstage__p_nstages_3_t;

  // Exposed methods
  VRegIncrNstage__p_nstages_3_t * VRegIncrNstage__p_nstages_3_create_model( const char * );
  void VRegIncrNstage__p_nstages_3_destroy_model( VRegIncrNstage__p_nstages_3_t *);
  void VRegIncrNstage__p_nstages_3_comb_eval( VRegIncrNstage__p_nstages_3_t * );
  void VRegIncrNstage__p_nstages_3_seq_eval( VRegIncrNstage__p_nstages_3_t * );
  void VRegIncrNstage__p_nstages_3_assert_on( VRegIncrNstage__p_nstages_3_t *, bool );
  bool VRegIncrNstage__p_nstages_3_has_assert_fired( VRegIncrNstage__p_nstages_3_t * );

  #if VLINETRACE
  void VRegIncrNstage__p_nstages_3_line_trace( VRegIncrNstage__p_nstages_3_t *, char * );
  #endif
...
VRegIncrNstage__p_nstages_3_t * VRegIncrNstage__p_nstages_3_create_model( const char *vcd_filename ) {

  VRegIncrNstage__p_nstages_3_t  * m;
  VRegIncrNstage___05Fp_nstages_3 * model;
  ...
  m     = new VRegIncrNstage__p_nstages_3_t;
  model = new VRegIncrNstage___05Fp_nstages_3(context_ptr);
...
void VRegIncrNstage__p_nstages_3_destroy_model( VRegIncrNstage__p_nstages_3_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncrNstage___05Fp_nstages_3 * model = (VRegIncrNstage___05Fp_nstages_3 *) m->_cffi_model;
...
void VRegIncrNstage__p_nstages_3_comb_eval( VRegIncrNstage__p_nstages_3_t * m ) {
...
void VRegIncrNstage__p_nstages_3_seq_eval( VRegIncrNstage__p_nstages_3_t * m ) {
...
void VRegIncrNstage__p_nstages_3_assert_on( VRegIncrNstage__p_nstages_3_t * m, bool enable ) {
...
bool VRegIncrNstage__p_nstages_3_has_assert_fired( VRegIncrNstage__p_nstages_3_t * m ) {
...
#if VLINETRACE
void VRegIncrNstage__p_nstages_3_line_trace( VRegIncrNstage__p_nstages_3_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_RegIncrNstage___05Fp_nstages_3__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.RegIncrNstage__p_nstages_3.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VRegIncrNstage___05Fp_nstages_3::line_trace( words );
