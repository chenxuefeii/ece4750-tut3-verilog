...
void VRegIncr2stage_noparam::line_trace(svBitVecVal* trace_str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRegIncr2stage_noparam___024root::line_trace\n"); );
    // Init
    ...
    VRegIncr2stage_noparam__Vcb_line_trace_t __Vcb = (VRegIncr2stage_noparam__Vcb_line_trace_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_W_SVBV(4096,trace_str__Vcvt,trace_str + 0);
(*__Vcb)((VRegIncr2stage_noparam__Syms*)(__Vscopep->symsp()), trace_str__Vcvt);
