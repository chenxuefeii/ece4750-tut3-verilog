//========================================================================
// VSortUnitFlat__p_nbits_8_v.cpp
//========================================================================
...
#include "obj_dir_SortUnitFlat__p_nbits_8/VSortUnitFlat___05Fp_nbits_8.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SortUnitFlat__p_nbits_8/VSortUnitFlat___05Fp_nbits_8__Syms.h"
#include "svdpi.h"
#endif
...
VSortUnitFlat__p_nbits_8_t * VSortUnitFlat__p_nbits_8_create_model( const char *vcd_filename ) {

  VSortUnitFlat__p_nbits_8_t  * m;
  VSortUnitFlat___05Fp_nbits_8 * model;
  ...
  m     = new VSortUnitFlat__p_nbits_8_t;
  model = new VSortUnitFlat___05Fp_nbits_8(context_ptr);
...
void VSortUnitFlat__p_nbits_8_destroy_model( VSortUnitFlat__p_nbits_8_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSortUnitFlat___05Fp_nbits_8 * model = (VSortUnitFlat___05Fp_nbits_8 *) m->_cffi_model;
...
void VSortUnitFlat__p_nbits_8_comb_eval( VSortUnitFlat__p_nbits_8_t * m ) {
...
void VSortUnitFlat__p_nbits_8_seq_eval( VSortUnitFlat__p_nbits_8_t * m ) {
...
void VSortUnitFlat__p_nbits_8_assert_on( VSortUnitFlat__p_nbits_8_t * m, bool enable ) {
...
bool VSortUnitFlat__p_nbits_8_has_assert_fired( VSortUnitFlat__p_nbits_8_t * m ) {
...
#if VLINETRACE
void VSortUnitFlat__p_nbits_8_line_trace( VSortUnitFlat__p_nbits_8_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_SortUnitFlat___05Fp_nbits_8__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.SortUnitFlat__p_nbits_8.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VSortUnitFlat___05Fp_nbits_8::line_trace( words );
