//========================================================================
// VRegIncrNstage__p_nstages_6_v.cpp
//========================================================================
...
#include "obj_dir_RegIncrNstage__p_nstages_6/VRegIncrNstage___05Fp_nstages_6.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncrNstage__p_nstages_6/VRegIncrNstage___05Fp_nstages_6__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VRegIncrNstage__p_nstages_6_t;

  // Exposed methods
  VRegIncrNstage__p_nstages_6_t * VRegIncrNstage__p_nstages_6_create_model( const char * );
  void VRegIncrNstage__p_nstages_6_destroy_model( VRegIncrNstage__p_nstages_6_t *);
  void VRegIncrNstage__p_nstages_6_comb_eval( VRegIncrNstage__p_nstages_6_t * );
  void VRegIncrNstage__p_nstages_6_seq_eval( VRegIncrNstage__p_nstages_6_t * );
  void VRegIncrNstage__p_nstages_6_assert_on( VRegIncrNstage__p_nstages_6_t *, bool );
  bool VRegIncrNstage__p_nstages_6_has_assert_fired( VRegIncrNstage__p_nstages_6_t * );

  #if VLINETRACE
  void VRegIncrNstage__p_nstages_6_line_trace( VRegIncrNstage__p_nstages_6_t *, char * );
  #endif
...
VRegIncrNstage__p_nstages_6_t * VRegIncrNstage__p_nstages_6_create_model( const char *vcd_filename ) {

  VRegIncrNstage__p_nstages_6_t  * m;
  VRegIncrNstage___05Fp_nstages_6 * model;
  ...
  m     = new VRegIncrNstage__p_nstages_6_t;
  model = new VRegIncrNstage___05Fp_nstages_6(context_ptr);
...
void VRegIncrNstage__p_nstages_6_destroy_model( VRegIncrNstage__p_nstages_6_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncrNstage___05Fp_nstages_6 * model = (VRegIncrNstage___05Fp_nstages_6 *) m->_cffi_model;
...
void VRegIncrNstage__p_nstages_6_comb_eval( VRegIncrNstage__p_nstages_6_t * m ) {
...
void VRegIncrNstage__p_nstages_6_seq_eval( VRegIncrNstage__p_nstages_6_t * m ) {
...
void VRegIncrNstage__p_nstages_6_assert_on( VRegIncrNstage__p_nstages_6_t * m, bool enable ) {
...
bool VRegIncrNstage__p_nstages_6_has_assert_fired( VRegIncrNstage__p_nstages_6_t * m ) {
...
#if VLINETRACE
void VRegIncrNstage__p_nstages_6_line_trace( VRegIncrNstage__p_nstages_6_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_RegIncrNstage___05Fp_nstages_6__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.RegIncrNstage__p_nstages_6.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VRegIncrNstage___05Fp_nstages_6::line_trace( words );
