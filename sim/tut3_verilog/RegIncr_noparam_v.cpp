...
#include "obj_dir_RegIncr_noparam/VRegIncr_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncr_noparam/VRegIncr_noparam__Syms.h"
#include "svdpi.h"
#endif
...
VRegIncr_noparam_t * VRegIncr_noparam_create_model( const char *vcd_filename ) {

  VRegIncr_noparam_t  * m;
  VRegIncr_noparam * model;
  ...
  m     = new VRegIncr_noparam_t;
  model = new VRegIncr_noparam(context_ptr);
...
void VRegIncr_noparam_destroy_model( VRegIncr_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncr_noparam * model = (VRegIncr_noparam *) m->_cffi_model;
...
void VRegIncr_noparam_comb_eval( VRegIncr_noparam_t * m ) {
...
void VRegIncr_noparam_seq_eval( VRegIncr_noparam_t * m ) {
...
void VRegIncr_noparam_assert_on( VRegIncr_noparam_t * m, bool enable ) {
...
bool VRegIncr_noparam_has_assert_fired( VRegIncr_noparam_t * m ) {
...
#if VLINETRACE
void VRegIncr_noparam_line_trace( VRegIncr_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_RegIncr_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.RegIncr_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VRegIncr_noparam::line_trace( words );
