...
#-------------------------------------------------------------------------
# RegIncr2stage_noparam
#-------------------------------------------------------------------------

class RegIncr2stage_noparam( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #       'libRegIncr2stage_noparam_v.so', os.path.getmtime( './libRegIncr2stage_noparam_v.so' ) ))
    ...
    s._ffi_inst = s.ffi.dlopen('./libRegIncr2stage_noparam_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)

    # increment instance count
    RegIncr2stage_noparam.id_ += 1
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VRegIncr2stage_noparam_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "RegIncr2stage_noparam.verilator1.vcd"
    ...
    s._ffi_m = s._ffi_inst.VRegIncr2stage_noparam_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VRegIncr2stage_noparam_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VRegIncr2stage_noparam_seq_eval
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VRegIncr2stage_noparam_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VRegIncr2stage_noparam_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 0:
      s._ffi_inst.VRegIncr2stage_noparam_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
