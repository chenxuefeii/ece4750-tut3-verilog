//========================================================================
// VRegIncrNstage__p_nstages_1_v.cpp
//========================================================================
...
#include "obj_dir_RegIncrNstage__p_nstages_1/VRegIncrNstage___05Fp_nstages_1.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RegIncrNstage__p_nstages_1/VRegIncrNstage___05Fp_nstages_1__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VRegIncrNstage__p_nstages_1_t;

  // Exposed methods
  VRegIncrNstage__p_nstages_1_t * VRegIncrNstage__p_nstages_1_create_model( const char * );
  void VRegIncrNstage__p_nstages_1_destroy_model( VRegIncrNstage__p_nstages_1_t *);
  void VRegIncrNstage__p_nstages_1_comb_eval( VRegIncrNstage__p_nstages_1_t * );
  void VRegIncrNstage__p_nstages_1_seq_eval( VRegIncrNstage__p_nstages_1_t * );
  void VRegIncrNstage__p_nstages_1_assert_on( VRegIncrNstage__p_nstages_1_t *, bool );
  bool VRegIncrNstage__p_nstages_1_has_assert_fired( VRegIncrNstage__p_nstages_1_t * );

  #if VLINETRACE
  void VRegIncrNstage__p_nstages_1_line_trace( VRegIncrNstage__p_nstages_1_t *, char * );
  #endif
...
VRegIncrNstage__p_nstages_1_t * VRegIncrNstage__p_nstages_1_create_model( const char *vcd_filename ) {

  VRegIncrNstage__p_nstages_1_t  * m;
  VRegIncrNstage___05Fp_nstages_1 * model;
  ...
  m     = new VRegIncrNstage__p_nstages_1_t;
  model = new VRegIncrNstage___05Fp_nstages_1(context_ptr);
...
void VRegIncrNstage__p_nstages_1_destroy_model( VRegIncrNstage__p_nstages_1_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRegIncrNstage___05Fp_nstages_1 * model = (VRegIncrNstage___05Fp_nstages_1 *) m->_cffi_model;
...
void VRegIncrNstage__p_nstages_1_comb_eval( VRegIncrNstage__p_nstages_1_t * m ) {
...
void VRegIncrNstage__p_nstages_1_seq_eval( VRegIncrNstage__p_nstages_1_t * m ) {
...
void VRegIncrNstage__p_nstages_1_assert_on( VRegIncrNstage__p_nstages_1_t * m, bool enable ) {
...
bool VRegIncrNstage__p_nstages_1_has_assert_fired( VRegIncrNstage__p_nstages_1_t * m ) {
...
#if VLINETRACE
void VRegIncrNstage__p_nstages_1_line_trace( VRegIncrNstage__p_nstages_1_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_RegIncrNstage___05Fp_nstages_1__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.RegIncrNstage__p_nstages_1.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VRegIncrNstage___05Fp_nstages_1::line_trace( words );
