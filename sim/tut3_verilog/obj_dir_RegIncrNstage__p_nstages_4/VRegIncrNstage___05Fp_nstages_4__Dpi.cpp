...
//    1. Call VRegIncrNstage___05Fp_nstages_4::{export_function} instead,
//       and do not even bother to compile this file
// or 2. Compile all __Dpi.cpp files in the same compiler run,
//       and #ifdefs already inserted here will sort everything out.

#include "VRegIncrNstage___05Fp_nstages_4__Dpi.h"
...
void line_trace(svBitVecVal* trace_str) {
    ...
    return VRegIncrNstage___05Fp_nstages_4::line_trace(trace_str);
}
#endif
